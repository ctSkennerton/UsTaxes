...
export class ScheduleCA extends Form {
  ...
  fields = (): Field[] => [
    ...
    /* The ordering of the fields below seems incorrect however it is correct as the 
       field indicies do not match the expected top to bottom ordering of the fields
       visually.
    */
